...
const WhmcsCustomTheme = (props) => {

    useEffect(() => {
        document.title = `WHMCS Theme Development Services - WHMCS ClientArea Development`;
  ...
  return (
    <>
        {/* Welcome Section */}
        <div className="product_banner service_banner custom_theme">
            <div className="container">
                <div className="row">
                    <div className="col-md-12 col-lg-7"> <span className="banner_tag">WHMCS Theme Dev</span>
                        <h1><span>WHMCS Custom Theme Development</span></h1>
                        <ul className="check_list">
                            <li> <span className="icon icon-checked"></span> Installation of Core Software </li>
                            <li> <span className="icon icon-checked"></span> Core Task Automation Setup </li>
                            <li> <span className="icon icon-checked"></span> Initial System Configuration </li>
                            <li> <span className="icon icon-checked"></span> Setup pf ! Hosting Server/Reseller Account </li>
                        </ul> <a href="//www.whmcsdigital.com/clientarea/submitticket.php?step=2&amp;deptid=2" className="default_btn">Get a Quote</a> </div>
       ...
       <section class="best_bussiness custom_theme">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="p_style">Be prepared to take advantage of extraordinary services that too under the same roof. Let's explore them!</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-7">
                        <div class="get_touch_text">
                            <h2>Do you want to know what you have to do? Then follow these steps.</h2>
                            <div class="get_box">
                                <div class="media">
                                    <div class="media-left"> <span class="icon icon-checked"></span> </div>
                                    <div class="media-body">
                                        <h3>Start your service from any WHMCS agency</h3>
                                        <p> The first thing to do is to choose your WHMCS agency.</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left"><span class="icon icon-checked"></span></div>
                                    <div class="media-body">
                                        ...
                                        <p>It's time to finish the task that was started.</p>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="media-left"> <span class="icon icon-checked"></span> </div>
                                    <div class="media-body">
                                        ...
                                        <p>Fill-the-blanks and update the version, and you will end up with this process.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="whmcs_services service_page custom_theme">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="h3_style">Professional WHMCS Custom Theme Development<br></br>Services We Offer</h2>
                    </div>
                </div>
...
export default WhmcsCustomTheme