        ...
        <section className="software testimonial_text">
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <div className="top_title">
                            <h2 className="h2_style">Trustpilot reviews <a href="https://www.trustpilot.com/review/whmcsdigital.com" className="default_btn" rel="noreferrer" target="_blank">Read More</a> </h2>
                        </div>
                    </div>
                </div>
                <div className="row ReviewsSlider row-40">
        ...
        <section className="software testimonial_text">
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <div className="top_title">
                            <h2 className="h2_style">Google Reviews <a href="https://goo.gl/maps/mLcAKrvf3J9v42YK6" className="default_btn" rel="noreferrer" target="_blank">Read More</a> </h2>
                        </div>
                    </div>
                </div>
                <div className="row ReviewsSlider row-40">
